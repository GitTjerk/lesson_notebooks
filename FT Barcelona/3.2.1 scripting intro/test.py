...
# Importar el archivo
# comprobar que todo está bien (tipos, número de filas)
# formatear fecha
# Crear dos tablas: la agregada por tienda y la agregada por producto
# conectar con db y guardar si todo está bien
# Guardar las tres tablas
# Podríamos checkear si hay alguna tienda nueva e insertarla
# Checkear si hay algún item nuevo e insertarlo
