...
ie.write_data(dataframe=todays_data, db_table='raw_sales', way='database', database_name=DATABASE_NAME, index=False)
ie.write_data(dataframe=agg_by_shop, db_table='sales_by_shop', way='database', database_name=DATABASE_NAME)
ie.write_data(dataframe=agg_by_item, db_table='sales_by_item', way='database', database_name=DATABASE_NAME)
